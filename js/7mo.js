...
$(document).ready(function(){
    ...
    if (localStorage.getItem('alumnos7mo')) {
        listUser = JSON.parse(localStorage.getItem('alumnos7mo'));
    }
    ...
    if(localStorage.getItem('alumnos7mo')){
        createTable('body', 'user-table');
        createTableHeader(['Id', 'Nombre', 'Apellido', 'Nota'], '#user-table');
        populateRows(getUserFromStorage('alumnos7mo'), '#user-table');
    }
