...
$(document).ready(function(){
    ...
    if (localStorage.getItem('alumnos2do')) {
        listUser = JSON.parse(localStorage.getItem('alumnos2do'));
    }
    ...
    if(localStorage.getItem('alumnos2do')){
        createTable('body', 'user-table');
        createTableHeader(['Id', 'Nombre', 'Apellido', 'Nota'], '#user-table');
        populateRows(getUserFromStorage('alumnos2do'), '#user-table');
    }
