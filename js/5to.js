...
$(document).ready(function(){
    ...
    if (localStorage.getItem('alumnos5to')) {
        listUser = JSON.parse(localStorage.getItem('alumnos5to'));
    }
    ...
    if(localStorage.getItem('alumnos5to')){
        createTable('body', 'user-table');
        createTableHeader(['Id', 'Nombre', 'Apellido', 'Nota'], '#user-table');
        populateRows(getUserFromStorage('alumnos5to'), '#user-table');
    }
