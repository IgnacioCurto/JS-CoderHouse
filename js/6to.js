...
$(document).ready(function(){
    ...
    if (localStorage.getItem('alumnos6to')) {
        listUser = JSON.parse(localStorage.getItem('alumnos6to'));
    }
    ...
    if(localStorage.getItem('alumnos6to')){
        createTable('body', 'user-table');
        createTableHeader(['Id', 'Nombre', 'Apellido', 'Nota'], '#user-table');
        populateRows(getUserFromStorage('alumnos6to'), '#user-table');
    }
